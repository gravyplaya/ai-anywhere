...
const REGISTERED_MODELS: CompactModelDef[] = [
  ...
  // =========================================================================
  {
    id: 'Huihui-LFM2.5-1.2B-Thinking-abliterated.Q8_0',
    name: 'LFM 2.5 Thinking Uncensored',
    repo: 'mradermacher/Huihui-LFM2.5-1.2B-Thinking-abliterated-GGUF',
    files: ['Huihui-LFM2.5-1.2B-Thinking-abliterated.Q8_0.gguf'],
    framework: LLMFramework.LlamaCpp,
    modality: ModelCategory.Language,
    memoryRequirement: 1_250_000_000,
  },
  {
    id: 'LFM2.5-1.2B-Instruct-Heretic.i1-Q4_K_M',
    name: 'LFM 2.5 Uncensored',
    repo: 'mradermacher/LFM2.5-1.2B-Instruct-Heretic-i1-GGUF',
  ...
  },
  {
    ...
    repo: 'VibeStudio/Nidum-Llama-3.2-3B-Uncensored-GGUF',
    files: ['model-Q4_0_4_4.gguf'],
    framework: LLMFramework.LlamaCpp,
    modality: ModelCategory.Language,
    memoryRequirement: 1_920_000_000,
  },
